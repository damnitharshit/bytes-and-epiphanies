...
### a.
Show that `sum` and `product` (Exercise 1.31) are both special cases of a more general notion called `accumulate` that combines a collection of terms, using some general accumulation function:
